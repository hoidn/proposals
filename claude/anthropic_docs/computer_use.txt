...
When using tools with 20250124 in their type (Claude 3.7 Sonnet tools), include this beta flag: `"betas": ["computer-use-2025-01-24"]` 

Note: The Bash (bash_20250124) and Text Editor (text_editor_20250124) tools are generally available for Claude 3.5 Sonnet (new) as well and can be used without the computer use beta header.

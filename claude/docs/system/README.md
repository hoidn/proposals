...
| Evaluator | Walk the AST, manage subtask calls, handle resource usage. | [Evaluator README](../components/evaluator/README.md) and [API](../components/evaluator/api/interfaces.md) |

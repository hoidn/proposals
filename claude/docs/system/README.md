...
| Evaluator | Process AST nodes, manage lexical environments, perform template substitution, and control execution. | [Evaluator README](../components/evaluator/README.md) and [API](../components/evaluator/api/interfaces.md) |

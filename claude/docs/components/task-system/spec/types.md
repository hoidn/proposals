...
export interface TaskResult {
    ...
    parsedContent?: any;
    /**
     * Task metadata generated by the LLM. Contains information about execution results, metrics, and other metadata.
     * This field is always preserved during task accumulation, even when using accumulation_format: 'notes_only'.
     */
    notes: {
        dataUsage: string;
        successScore?: number;
...
export interface TaskOutput {
    ...
    output: string;  // The main content (preserved only with full_output)
    notes: any;      // Task notes field (always preserved)
    timestamp: Date;
}

# TODO def task_system.get_reparse_prompt(failed_task: str,
#                                   error)

class XMLTaskParser:
    """Parses XML task descriptions into structured form"""
    
# TODO this is the responsibility of Compiler.parse(), which exists. 
# but Some of the xml parsing logic here might have to be moved there
